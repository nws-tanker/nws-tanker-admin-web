...
import { PendingReviewSidebar } from '../components/PendingReviewSidebar';
...
export default function PendingReviewInspectionDetails({ data }: Props) {
  return (
    <div className="grid grid-cols-[1fr_300px] gap-6 items-start">
      ...
      <div className="sticky top-6">
        <PendingReviewSidebar data={data} />
      </div>
    </div>
  );
}
